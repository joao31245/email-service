...
Esses são os principais metodos, porém o sistema implementa todo o crud básico, então para mais detalhes, ao rodar a API, consulte: http://localhost:8080/swagger-ui/index.html#
